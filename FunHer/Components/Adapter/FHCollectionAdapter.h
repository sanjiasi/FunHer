...
typedef void (^HeaderConfigureBefore)(id reusableview, NSString *headerId, NSIndexPath *indexPath);
...
@property (nonatomic, copy) HeaderConfigureBefore headerConfigure;
