...
- (void)setupUI
{
    ...
    self.btnSelect.frame = CGRectMake(GetViewWidth(self.contentView)-26, 5, 24, 24);
    ...
    self.indexLabel = [[UILabel alloc] initWithFrame:self.btnSelect.frame];
    self.indexLabel.layer.cornerRadius = 24.0 / 2;
