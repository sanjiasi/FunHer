...
@property (nonatomic, copy, nullable) void (^selectImageTempBlock)(NSArray<UIImage *> *_Nullable images, NSArray<PHAsset *> *assets, BOOL isOriginal,UIViewController * selecter);
